...
if uploaded_file is not None:
    ...
    with tab1:
        ...
        if affiliate_selected == "All":
            ...
            # Build complete skeleton: all systems x all active statuses
            ...
            # Actual counts from active filtered data
            chart_df = (
                df_active_filtered
            ...
            # Merge skeleton with actual counts so zeros are preserved
        ...
        # ================= CASE: SPECIFIC SYSTEM SELECTED =================
            ...
            # Build skeleton: selected system x all active statuses
            system_skeleton = pd.DataFrame({
                "status": all_active_statuses,
                "Count": 0
            })

            # Actual counts for selected system
            chart_df_system = (
                df_active_filtered
                .groupby("status")
                .size()
